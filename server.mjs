...
import setup from './php-container/wasm/php-web-wordpress.js';
	...
	async init() {
      ...
      locateFile(name) {
			...
			onPreInit: function (FS, NODEFS) {
				...
				FS.mount(NODEFS, { root: "./php-container/etc" }, "/usr/local/etc");
				FS.mkdirTree("/preload/wordpress");
				FS.mount(NODEFS, { root: "./php-container/wordpress" }, "/preload/wordpress");
